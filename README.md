...
It grants a user permission to use the app. The server tests for authenticity for the user. 

- [ x] What steps can you take in your web apps to keep your data secure?

Using tokens, using private routes in the app you created, not using passwords as plain text.

- [ x] Describe how web servers work.

It stores, and processes web pages to users. 
